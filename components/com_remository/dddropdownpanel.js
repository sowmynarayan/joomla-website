...
var defaultpanel=new ddpanel({
	ids: ["remositorysearch", "remositorysearchcontent", "remositorysearchtab"], // id of main panel DIV, content DIV, and tab DIV
	...
	pointerimage: {enabled: true, src: ["components/com_remository/images/dddpanel/arrow-down.gif", "components/com_remository/images/dddpanel/arrow-up.gif"]},
