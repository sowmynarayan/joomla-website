...
if (defined('_ALIRO_IS_PRESENT')) {
	class bot_remositoryVideo extends aliroPlugin {
		...
		public function remositoryVideoPlayer ($link, $title) {
			$worker = new remository_plugin_video();
			return $worker->remositoryVideoPlayer ($this->params, $link, $title);
		}
...
class remository_plugin_video extends remositoryAddOnController {
	...
	public function remositoryVideoPlayer ($botparams, $link, $title) {
		?>
		<!-- id=MediaPlayer1 -->
