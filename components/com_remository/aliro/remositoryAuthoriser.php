...
define ('_ALIRO_AUTHORISER_SESSION_CACHE_TIME', 300);
...
class aliroAuthoriserCache {
	...
	// private function? Not in this context, called by the cache mechanism in CMS?
	function getRoleData () {
		$interface = remositoryInterface::getInstance();
		$database = $interface->getDB();
		$database->setQuery("SELECT DISTINCT role FROM #__assignments UNION SELECT DISTINCT role FROM #__permissions");
