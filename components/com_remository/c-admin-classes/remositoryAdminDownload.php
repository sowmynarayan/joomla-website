...
class remositoryAdminDownload extends remositoryAdminControllers {
	...
	function listTask () {
		...
		if ($nofile) {
			...
			// <br>&nbsp;<br><a href=../../index.php?option=com_remository&amp;repnum=$this->repnum><img src="$mosConfig_live_site/components/com_remository/images/gohome.gif" width="32" height="32" border="0" align="absmiddle"> $maindl</a>
			echo <<<LINK_REMOS
			
			<br>&nbsp;<br><a href=../../index.php?option=com_remository><img src="$mosConfig_live_site/components/com_remository/images/gohome.gif" width="32" height="32" border="0" align="absmiddle"> $maindl</a>
