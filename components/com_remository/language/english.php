...
if (!defined('_DOWN_NEW_UPDATED_MSG')) DEFINE ('_DOWN_NEW_UPDATED_MSG', 
					"At %s a file has been added or updated.  The file title is %s."
...
if (!defined('_DOWN_INSTALL_DONE1')) DEFINE ('_DOWN_INSTALL_DONE1', 'You are strongly recommended to look at the Release notes in read_me.txt');
...
if (!defined('_DOWN_CANCEL_UPLOAD')) DEFINE ('_DOWN_CANCEL_UPLOAD', 'Cancel upload');
...
if (!defined('_DOWN_REG_ONLY_WARN')) DEFINE("_DOWN_REG_ONLY_WARN","This location is for Registered Users Only.<BR />"
                             ."Perhaps you need to login or register.</a>.");
