...
$joomlaWatch->visit->insertVisit($joomlaWatchHTML->mosConfig_live_site);
 ...
 * Matej Koval
*/
if ($joomlaWatch->config->getCheckboxValue("JOOMLAWATCH_FRONTEND_LINK")) {
...
/* supress possible warnings from other modules */ 
error_reporting(0);	
?>