...
class JSNBackup{
	...
	function executeBackup($filename)
	{
		...
		$schema .= $this->getTableInfo($db, 'poll_data', $database_prefix);
		$schema .= $this->getTableInfo($db, 'poll_date', $database_prefix);
		$schema .= $this->getTableInfo($db, 'poll_menu', $database_prefix);
		$schema .= $this->getTableInfo($db, 'polls', $database_prefix);
		$schema .= $this->getTableInfo($db, 'menu_types', $database_prefix);
		$schema .= $this->getTableInfo($db, 'menu', $database_prefix);
		$schema .= $this->getTableInfo($db, 'sections', $database_prefix);
		$schema .= $this->getTableInfo($db, 'categories', $database_prefix);
		$schema .= $this->getTableInfo($db, 'content_frontpage', $database_prefix);
		$schema .= $this->getTableInfo($db, 'modules_menu', $database_prefix); 
		$schema .= $this->getTableInfo($db, 'modules', $database_prefix);
		$schema .= $this->getTableInfo($db, 'content', $database_prefix);     	        
